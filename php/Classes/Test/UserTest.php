...
class UserTest extends ApciMapTest {
	 ...
	 */
	protected $VALID_USERACTIVATION = "ALP127CTINP3L4G8AINTN8A2N8FO3NRI";
	/**
	 * valid user email
	 * @var string $VALID_USEREMAIL
	 */
	protected $VALID_USEREMAIL = "lba@cnm.edu";
/**
 * valid user hash for user account
 * @var string $VALID_USERHASH
 */
	protected $VALID_USERHASH = "d4k6fiofjiaomfrc98tmcjfiwoam894pwu4983mcftja8r943mjf4mjr483qmrcjp9mjfcx8943qh459frjeoifnmcwaonfje";
	/**
