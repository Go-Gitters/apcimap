							...
							<Card bg="primary" className="border-0 rounded-0 text-white text-shadow-dark">
								<Card.Body>
									...
									<p>Property value data comes from the Bernalillo County Assessor's Office. This represents
										the assessed value of the property and may or may not reflect sales value.</p>
									...
									<h2>Our Team</h2>
									<p>Go Gitters is a Fullstack Web Development bootcamp at CNM Ingenuity's Deep Dive Coding.
										The team consists of Lindsey Atencio, Kyla Bendt, and Lisa Lee.</p>
									<p>The Albuquerque Property-Crime Incident Map application represents our teams capstone
										project.</p>
								</Card.Body>
							</Card>
						</Col>
